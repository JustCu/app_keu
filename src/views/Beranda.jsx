  ...
  return (
    <div>
      ...
      <section className="px-4 mt-4">
        <div className="relative bg-gradient-to-br from-blue-900 via-blue-800 to-gray-900 rounded-2xl p-6 text-white shadow-xl overflow-hidden flex flex-col gap-5">
          {/* Decorative Backgrounds */}
          <div className="absolute top-0 right-0 w-40 h-40 bg-white opacity-5 rounded-full -mr-16 -mt-16 pointer-events-none"></div>
          <div className="absolute bottom-0 left-0 w-32 h-32 bg-blue-500 opacity-10 rounded-full -ml-10 -mb-10 pointer-events-none"></div>
          ...
          <div className="flex justify-between items-center relative z-10">
            <div className="flex items-center gap-2">
              ...
              <p className="text-blue-100 text-xs font-bold uppercase tracking-wider">Total Saldo</p>
            </div>
            <button onClick={() => setIsBalanceHidden(!isBalanceHidden)} className="text-blue-200 hover:text-white p-1 rounded-full hover:bg-white/10 transition active:scale-95">
          ...
          <div className="relative z-10">
            <div className="flex items-baseline gap-1">
              <span className="text-blue-200 text-lg font-bold">Rp</span>
              {isBalanceHidden ? (
                <h2 className="text-4xl font-bold tracking-tight mt-1">••••••••</h2>
              ) : (
          ...
          <div className="relative z-10 bg-white/10 backdrop-blur-md rounded-xl p-4 flex justify-between border border-white/10 mt-2">
            ...
            <div className="flex-1 flex gap-3 items-center">
              ...
              <div>
                <p className="text-[10px] text-blue-200 uppercase tracking-wider font-bold">Masuk</p>
                <p className="text-sm font-bold text-white mt-0.5">
                  {isBalanceHidden ? 'Rp •••••••' : `Rp ${formatRupiah(totalMasuk)}`}
                </p>
              </div>
            </div>
            ...
            <div className="flex-1 flex gap-3 items-center pl-2">
              ...
              <div>
                <p className="text-[10px] text-blue-200 uppercase tracking-wider font-bold">Keluar</p>
                <p className="text-sm font-bold text-white mt-0.5">
                  {isBalanceHidden ? 'Rp •••••••' : `Rp ${formatRupiah(totalKeluar)}`}
                </p>
              </div>
            </div>
               ...
               return (
                 <div key={index} className="flex justify-between items-center">
                   <div className="flex items-center gap-4">
                     <div className={`w-12 h-12 rounded-2xl flex items-center justify-center text-xl shadow-sm border ${iconBg}`}>
                       {icon}
                     </div>
                     <div>
